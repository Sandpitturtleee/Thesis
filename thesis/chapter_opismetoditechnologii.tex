...
W niniejszej pracy wykorzystany został język programowania Python w wersji 3.14.6 \cite{python}. Wybór ten wynikał z faktu, że jest to stabilna i dobrze przetestowana dystrybucja tego oprogramowania. Pozwala ona na korzystanie z wielu zewnętrznych bibliotek i paczek bez konfliktów związanych z niezgodnością wersji. Oprócz tego z każdą kolejną aktualizacją języka dodawane są do niego kolejne usprawnienia dlatego w miarę możliwości powinno używać się go w jak najnowszej wersji.
