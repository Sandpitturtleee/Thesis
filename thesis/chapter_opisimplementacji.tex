...
Podstawowy sposób działania algorytmu Dijkstry został przedstawiony w alg.~\ref{alg:dijkstra}. Wszystkie implementacje użyte w części działają według tego samego schematu. Różnią się przede wszystkim sposobem wykonania operacji wyboru nieodwiedzonego wierzchołka o najmniejszej aktualnie znanej odległości.
